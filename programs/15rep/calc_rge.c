...
// Initial condition
  ...
  b_in   =  4.1;             // coefficient of one loop
...
//  Intermediate Particle
  mu_1 = 250; // The Scale where the particle added [GeV]
  b_1  = 1.0/30.0; // Value of Additional b value

  mu_2 = 1540; // The Scale where the particle added [GeV]
  b_2  = 3.0/5.0; // Value of Additional b value
