...
// Initial condition
// NOTE: This program is fixed for U(1) (regularized in SU(5)) running gauge coupling.
  g      =  0.461425;      // Coupling constant at Energy = mu
  mu     =  91.876;        // Initial Energy Scale [GeV]
  b_in   =  4.10;           // coefficient of one loop
...
//  Intermediate Particle
  mu_1 = 1600; // The Scale where the particle added [GeV]
  b_1  = 3.0/5.0; // Value of Additional b value

  mu_2 = 1800; // The Scale where the particle added [GeV]
  b_2  = 1.0/30.0; // Value of Additional b value
