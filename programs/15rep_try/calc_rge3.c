...
// Initial condition
// NOTE: This program is fixed for SU(3) (regularized in SU(5)) running gauge coupling.
  g      =  1.2143;      // Coupling constant at Energy = mu
...
//  Intermediate Particle
  ...
  b_1  = 0.0/3.0; // Value of Additional b value

  mu_2 = 1800; // The Scale where the particle added [GeV]
  b_2  = 1.0/3.0; // Value of Additional b value
